...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=str,
        default="",
        help="Directory in which samples should be saved & loaded for confidence model.",
    )
    parser.add_argument(
        "--use_randomized_confidence_data",
        action="store_true",
        default=False,
        help="If true, randomly generated data for training the confidence model. Else, use data generated by score model",
    )
    parser.add_argument(
