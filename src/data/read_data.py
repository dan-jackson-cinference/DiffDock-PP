...
class DataReader(ABC):
    ...
    def load_data(self):
        data_to_load = load_csv(self.data_file)
...
class SinglePairReader(DataReader):
    def __init__(self, pdb_id: str, receptor_path: str, ligand_path: str):
        self.pdb_id = pdb_id
    ...
    def read_files(self):
        receptor = parse_pdb(self.receptor_path, self.pdb_id)
        ligand = parse_pdb(self.ligand_path, self.pdb_id)
